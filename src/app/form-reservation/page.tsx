...
function FormReservation() {
  ...
  const {
    ...
    error: fetchError,
    isLoading,
  } = useFindBookingQuery(bookingNumber, {
  ...
  return (
    <div className="bg-gray-100 min-h-screen px-2 md:px-10">
        ...
        <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="bg-[#C4B4A7] hover:bg-[#D8C8BB] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                Search
              </button>
            </form>
                ...
                <>
                  ...
                  <div className="flex justify-center">
                    <button
                      ...
                      className="bg-[#C4B4A7] hover:bg-[#D8C8BB] text-white font-bold py-2 px-4 mt-2 rounded focus:outline-none focus:shadow-outline"
                    >
                      Search Again
                    </button>
                  </div>
